...
public static class Ui
{
    ...
    private static void AdminCreateNewUser()
    {
        ...
        _registeredPassword = GetPassword();
        _registeredPhoneNumber = GetPhoneNumber();
        // var promptPadding = 2.2f;
        // var messagePadding = 1.7f;
        //
        // string? firstName;
        // do
        // {
        ...
        //     Logo.DisplayFullLogo();
        //     
        //     Console.Write("First Name: ".PadLeft("First Name: ".Length + (int)((Console.WindowWidth - "First Name: ".Length) / promptPadding)));
        //     
        // } while (string.IsNullOrEmpty(firstName = Console.ReadLine()));
        //
        // string? lastName;
        // do
        // {
        ...
        //     Logo.DisplayFullLogo();
        //     
        //     Console.Write("Last Name: ".PadLeft("Last Name: ".Length + (int)((Console.WindowWidth - "Last Name: ".Length) / promptPadding)));
        //     
        // } while (string.IsNullOrEmpty(lastName = Console.ReadLine()));
        //
        // string? email;
        ...
        //     Logo.DisplayFullLogo();
        //     
        //     Console.Write("Email: ".PadLeft("Email: ".Length + (int)((Console.WindowWidth - "Email: ".Length) / promptPadding)));
        //     
        //     email = Console.ReadLine();
        //     if (email != null && Regex.IsMatch(email, EmailPattern))
        //     {
        ...
        //         Console.WriteLine();
        //         var message1 = "\u001b[38;2;255;69;0mThis email is already in use\u001b[0m";
        //         Console.Write($"{message1}".PadLeft(message1.Length + (int)((Console.WindowWidth - message1.Length) / messagePadding)));
        //     }
        //     else
        //     {
        //         Console.WriteLine();
        //         var message2 = "\u001b[38;2;255;69;0mPlease enter a valid email address\u001b[0m";
        //         Console.Write($"{message2}".PadLeft(message2.Length + (int)((Console.WindowWidth - message2.Length) / messagePadding)));
        //     }
        //
        //     Thread.Sleep(2000);
        // }
        ...
        //     Logo.DisplayFullLogo();
        //         
        //     Console.Write("Password: ".PadLeft("Password: ".Length + (int)((Console.WindowWidth - "Password: ".Length) / promptPadding)));
        //
        ...
        //     Console.WriteLine();
        //     var message = "\u001b[38;2;255;69;0mPassword has to be at least 8 characters long\u001b[0m";
        //     Console.WriteLine($"{message}".PadLeft(message.Length + (int)((Console.WindowWidth - message.Length) / messagePadding)));
        //     
        //     Thread.Sleep(3000);
        // }
        //
        ...
        //     Logo.DisplayFullLogo();
        //     
        //     Console.Write("Phone Number: ".PadLeft("Phone Number: ".Length + (int)((Console.WindowWidth - "Phone Number: ".Length) / promptPadding)));
        //     
        ...
        //         Console.WriteLine();
        //         var message1 = "\u001b[38;2;255;69;0mThis phone number is already in use\u001b[0m";
        //         Console.WriteLine($"{message1}".PadLeft(message1.Length + (int)((Console.WindowWidth - message1.Length) / messagePadding)));
        //     }
        //     else
        //     {
        //         Console.WriteLine();
        //         var message2 = "\u001b[38;2;255;69;0mPlease enter a valid phone number with '+46' at the beginning\u001b[0m";
        //         Console.WriteLine($"{message2}".PadLeft(message2.Length + (int)((Console.WindowWidth - message2.Length) / messagePadding)));
        //     }
        //     
        //
        //     Thread.Sleep(2000);
